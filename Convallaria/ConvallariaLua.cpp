...
// @Return: None
//------------------------------------------------------------------
lua_State *CONVALLARIA_CALLMETHOD CConvallariaLua::CConvallariaLua_GetLua() const
{
	return L;
}
...
// @Return: None
//------------------------------------------------------------------
BOOL CONVALLARIA_CALLMETHOD CConvallariaLua::ConvallariaLua_Init()
{
...
// @Return: None
//------------------------------------------------------------------
void CONVALLARIA_CALLMETHOD CConvallariaLua::ConvallariaLua_GetGlobal_Int(const char * szVar, int & nValue)
{
...
// @Return: None
//------------------------------------------------------------------
void CONVALLARIA_CALLMETHOD CConvallariaLua::ConvallariaLua_GetGlobal_Long(const char * szVar, long & lValue)
{
	lua_getglobal(L, szVar);
...
// @Return: None
//------------------------------------------------------------------
void CONVALLARIA_CALLMETHOD CConvallariaLua::ConvallariaLua_GetGlobal_LongLong(const char * szVar, long long & llValue)
{
	lua_getglobal(L, szVar);
...
// @Return: None
//------------------------------------------------------------------
void CONVALLARIA_CALLMETHOD CConvallariaLua::ConvallariaLua_GetGlobal_Float(const char * szVar, float & fValue)
{
	lua_getglobal(L, szVar);
...
// @Return: None
//------------------------------------------------------------------
void CONVALLARIA_CALLMETHOD CConvallariaLua::ConvallariaLua_GetGlobal_Double(const char * szVar, double & dValue)
{
	lua_getglobal(L, szVar);
...
// @Return: None
//------------------------------------------------------------------
void CONVALLARIA_CALLMETHOD CConvallariaLua::ConvallariaLua_GetGlobal_String(const char * szVar, const char * pStr, int nSize)
{
	std::string str;
	lua_getglobal(L, szVar);
...
// @Return: None
//------------------------------------------------------------------
void CONVALLARIA_CALLMETHOD CConvallariaLua::ConvallariaLua_GetTable_String(const char * szVar1, const char * szVar2, const char * pStr, int nSize)
{
	std::string str;
...
// @Return: None
//------------------------------------------------------------------
void CONVALLARIA_CALLMETHOD CConvallariaLua::ConvallariaLua_CallFunc(const char * szVar, int nMessageID, LPVOID pTransBuf, int nTransSize, LPVOID pRecevBuf, int nRecevSize)
{
	switch (nMessageID)
	{
